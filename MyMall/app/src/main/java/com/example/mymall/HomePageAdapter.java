...
public class HomePageAdapter extends RecyclerView.Adapter {
    ...
    public void onBindViewHolder(@NonNull RecyclerView.ViewHolder viewHolder, int position) {
        switch (homePageModelList.get(position).getType()){
            ...
            case HomePageModel.HORIZONTAL_PRODUCT_VIEW:
                ...
                List<ViewAllProduct> viewAllProductList = homePageModelList.get(position).getViewAllProductList();
    ...
    public class HorizontalProductViewholder extends RecyclerView.ViewHolder{
        ...
        private void setHorizontalProductLayout(List<HorizontalProductScrollModel> horizontalProductScrollModelList, final String title, String color, final List<ViewAllProduct> viewAllProductList){
            ...
            if(horizontalProductScrollModelList.size()>8){
                ...
                horizontalLayoutViewAllBtn.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ViewAllActivity.viewAllProductList = viewAllProductList;
