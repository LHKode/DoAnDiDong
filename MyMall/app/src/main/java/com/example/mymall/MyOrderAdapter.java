...
public class MyOrderAdapter extends RecyclerView.Adapter<MyOrderAdapter.Viewholder> {
    ...
    class Viewholder extends RecyclerView.ViewHolder{
        ...
        private TextView deliverySatus;
        ...
        public Viewholder(@NonNull final View itemView) {
            ...
            deliverySatus = itemView.findViewById(R.id.order_delivered_date);
        ...
        private void setData(int resource,String title,String deliveredDate,int rating){
            ...
            deliverySatus.setText(deliveredDate);
